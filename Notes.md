...
All 5 features done and merged to main. Awaiting review/merge of PR #23 (chore/readme-updates -> main, README accuracy fixes + badges). After that: nothing left to build — consider /publish, or ask the user what's next.
...
| 4-browser-session-tools | 4-advance-page | story/4-browser-session-tools/4-advance-page | pr-open |
...
Await review/merge of PR #17 (story/4-browser-session-tools/4-advance-page -> feature/4-browser-session-tools). On merge: mark story merged, delete story branch, then run /stage-a 4-browser-session-tools/5-fill-credential-field.